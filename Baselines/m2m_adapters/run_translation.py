...
class DataTrainingArguments:
    ...
    data_path: Optional[str] = field(
        default=None, metadata={"help": "original data path."}
    )
    domain_task: Optional[str] = field(
        default=None, metadata={"help": "which task of domain."}
    )
...
def main():
    ...
    for ll in lang_list:
        ...
        def preprocess_function(examples):
            ...
            model_inputs = tokenizer(inputs, max_length=data_args.max_source_length, padding=padding,
                                     truncation=True)
